...
export default function HeroSection() {
  return (
    <section className={styles.hero} id="home">
      {/* Subtle bg code matrix lines on left */}
      <div className={styles.bgMatrix}></div>
